    ...
    private val cropActivityResultLauncher = registerForActivityResult(
        ...
        if (result.resultCode == RESULT_OK) {
            ...
            if (result.resultCode == Activity.RESULT_CANCELED) {
                viewModel.currentImageUri = null  // Set currentImageUri menjadi null jika proses cropping dibatalkan
                binding.previewImageView.setImageResource(R.drawable.ic_place_holder)  // Tambahkan placeholder image jika diperlukan
                showToast("Cropping dibatalkan")
